...
Credit: NASA's Scientific Visualization Studio. LROC / Lunar Reconnaissance Orbiter camera and LOLA instrument teams. Visualization: Ernie Wright (USRA).

Source page: https://svs.gsfc.nasa.gov/4720/ — CGI Moon Kit.

- `lroc-color-2k.jpg`: 2025 color map, 2048 × 1024, https://svs.gsfc.nasa.gov/vis/a000000/a004700/a004720/lroc_color_2k.jpg
...
- `seated-rabbit-hero.png`：用户提供的透明小白兔素材（2026-09-23 20:29），首页岩石上的坐姿角色。
- `lunar-landscape-hero.png`：由用户提供的银河与月面背景图（2026-09-23 20:46）局部移除原图中的小白兔后保存，供网页独立叠加透明角色和交互月球。保留原图的地球、银河、流星、月面与岩石构图。
